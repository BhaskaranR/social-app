...
let messengerhandler: any = {};
const basicPin = {
    role: 'messenger'
};

messengerhandler.getConversationById = (request, reply) => {
...
messengerhandler.getMyConversations = (request, reply) => {
...
messengerhandler.getMessagesByConversationId = (request, reply) => {
...
messengerhandler.postConversation = (request, reply) => {
...
messengerhandler.postMessage = (request, reply) => {
...
messengerhandler.ackConversation = (request, reply) => {
